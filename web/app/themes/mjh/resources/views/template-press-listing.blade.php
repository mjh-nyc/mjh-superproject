  ...
  <div class="row">
    ...
    @else
      <div class="press-content-main col-md-8">
        ...
        @if($releases)
          <h3>@php _e("Statements &amp; Press Releases","sage"); @endphp</h3>
          ...
          <div class="see-all">
            <a href="/press/releases/" class="cta-round cta-arrow cta-secondary">@php _e("See All Statements &amp; Press Releases","sage"); @endphp</a>
          </div>
        @endif
