<header class="banner">
  ...
  @if (!is_front_page())
    <div class="hero-area parallax-window" data-parallax="scroll" data-image-src="@if (App::isPageTemplate( 'views/template-core.blade.php') ) {!! App::featuredImageSrc('large', App::getCoreExhibitionID()) !!} @else {{App::featuredImageSrc('large')}} @endif" data-over-scroll-fix="true" alt="{{App::featuredImageAlt(get_post_thumbnail_id())}}">
